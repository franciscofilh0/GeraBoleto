...
var
  ListItem: TListItem;
begin
  ListItem := ListViewBoletos.Items.Add();
  ListItem.Caption := FormatFloat('000', FContainer.Boletos.Count);
  ListItem.SubItems.Add(ABoleto.GetConta.Banco.Nome);
  ListItem.SubItems.Add(ABoleto.GetPagador.Nome);
  ListItem.SubItems.Add(ABoleto.GetPagador.CnpjCpf);
  ListItem.SubItems.Add(FormatFloat(',0.00', ABoleto.GetTitulo.Valor));
  ListItem.SubItems.Add(FormatDateTime('DD/MM/YYYY', ABoleto.GetTitulo.Vencimento));
  ListItem.SubItems.Add(FormatDateTime('DD/MM/YYYY', ABoleto.GetTitulo.Emissao));
end;
