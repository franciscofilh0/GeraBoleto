object frmBoletoFortesReport: TfrmBoletoFortesReport
  Left = 0
  Top = 0
  Caption = 'frmBoletoFortesReport'
  ClientHeight = 841
  ClientWidth = 820
  Color = clBtnFace
  ...
  object BoletoFortes: TRLReport
    ...
    object RLBandPrin: TRLBand
      ...
      object bcCodigoBarras: TRLBarcode
        Left = 4
        Top = 464
        Width = 421
        Height = 50
  ...
  object dsBoleto: TDataSource
    DataSet = dmDadosBoletos.Boletos
    Left = 360
    Top = 616
  end
end
